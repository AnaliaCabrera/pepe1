                        ...
                        if n%2 == 0 :
                            ...
                            for kimp in range(aux1b-1,aux1a-1,-1) :
                                ...
                                if monitor[r+numors*25] != 0 and  f[kimp] != 0 :
                                    #Para la parte [2]
                                    Idrh1[n-1][kio][kj]=Idrh1[n-1][kio][kj]+peso*f[kimp]
                                    Idrh1[n-1][kio][kj+1]=Idrh1[n-1][kio][kj+1]+(1-peso)*f[kimp]
                                    
                                    Idrh2[n-1][kio][kj]=Idrh2[n-1][kio][kj]+peso*monitor[r+numors*25]
                                    Idrh2[n-1][kio][kj+1]=Idrh2[n-1][kio][kj+1]+(1-peso)*monitor[r+numors*25]
                                    
                                    E_Idrh1[n-1][kio][kj]=E_Idrh1[n-1][kio][kj]+(peso**2)*(f[kimp])
                                    E_Idrh1[n-1][kio][kj+1]=E_Idrh1[n-1][kio][kj+1]+((1-peso)**2)*(f[kimp])
                 ...
                 #               I_2_d[kio][kj+1]=I_2_d[kio][kj+1]+(1.0-peso)*(f[kimp])**2
                            ...
                            for k in range(aux1b-1,aux1a-1,-1) :
                                ...
                                if monitor[r+numors*25] != 0 and  f[k] != 0 :
                                    #Para la parte [2]
                                    Idrh1[n-1][ki][kj]=Idrh1[n-1][ki][kj]+peso*f[k]
                                    Idrh1[n-1][ki][kj+1]=Idrh1[n-1][ki][kj+1]+(1-peso)*f[k]
                                    
                                    Idrh2[n-1][ki][kj]=Idrh2[n-1][ki][kj]+peso*monitor[r+numors*25]
                                    Idrh2[n-1][ki][kj+1]=Idrh2[n-1][ki][kj+1]+(1-peso)*monitor[r+numors*25]
                                    
                                    E_Idrh1[n-1][ki][kj]=E_Idrh1[n-1][ki][kj]+(peso**2)*(f[k])
                                    E_Idrh1[n-1][ki][kj+1]=E_Idrh1[n-1][ki][kj+1]+((1-peso)**2)*(f[k])
...
#%%
Idrh=np.divide(Idrh1, Idrh2,out=np.zeros_like(Idrh1), where=Idrh2!=0) #DIVIDIRA LAS 128 MATRICES POR LAS 128?
...
for d in range(0,128):
    Effi_d[d]=np.divide(Ideal_Mo, Idrh[d],out=np.zeros_like(Ideal), where=Idrh[d]!=0)
