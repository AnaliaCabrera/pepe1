                        ...
                        if n%2 == 0 :
                            ...
                            for kimp in range(aux1b-1,aux1a-1,-1) :
                                ...
                                if monitor[r+numors*25] != 0 and  f[kimp] != 0 :
                                    #Para la parte [2]
                                    Idrh1[n-1][kio][kj]=Idrh1[n-1][kio][kj]+peso*f[kimp]/monitor[r+numors*25]
                                    Idrh1[n-1][kio][kj+1]=Idrh1[n-1][kio][kj+1]+(1-peso)*f[kimp]/monitor[r+numors*25]
                 ...
                 #               I_2_d[kio][kj+1]=I_2_d[kio][kj+1]+(1.0-peso)*(f[kimp])**2
                            ...
                            for k in range(aux1b-1,aux1a-1,-1) :
                                ...
                                if monitor[r+numors*25] != 0 and  f[k] != 0 :
                                    #Para la parte [2]
                                    Idrh1[n-1][ki][kj]=Idrh1[n-1][ki][kj]+peso*f[k]/monitor[r+numors*25]
                                    Idrh1[n-1][ki][kj+1]=Idrh1[n-1][ki][kj+1]+(1-peso)*f[k]/monitor[r+numors*25]
