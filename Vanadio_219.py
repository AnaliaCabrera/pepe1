...
Ideal, Ideal1 = Prom_Ponderado(Idrh1,W_relativo,fil,fil,col*25+1+maxteta-25)
...
for d in range(0,128):
    Effi_d[d]=np.divide(Ideal_Mo, Idrh3[d],out=np.zeros_like(Ideal_Mo), where=Idrh3[d]!=0)
