                        ...
                        if n%2 == 0 :
                            ...
                            for kimp in range(aux1b-1,aux1a-1,-1) :
                                ...
                                if monitor[r+numors*25] != 0 and  f[kimp] != 0 :
                                    ...
                                    E_Idrh1[128-n][kio][kj]=E_Idrh1[n-1][kio][kj]+(peso**2)*(f[kimp]/monitor[r+numors*25])
                                    E_Idrh1[128-n][kio][kj+1]=E_Idrh1[n-1][kio][kj+1]+((1-peso)**2)*(f[kimp]/monitor[r+numors*25])
                 ...
                 #               I_2_d[kio][kj+1]=I_2_d[kio][kj+1]+(1.0-peso)*(f[kimp])**2
                            ...
                            for k in range(aux1b-1,aux1a-1,-1) :
                                ...
                                if monitor[r+numors*25] != 0 and  f[k] != 0 :
                                    ...
                                    E_Idrh1[128-n][ki][kj]=E_Idrh1[n-1][ki][kj]+(peso**2)*(f[k]/monitor[r+numors*25])
                                    E_Idrh1[128-n][ki][kj+1]=E_Idrh1[n-1][ki][kj+1]+((1-peso)**2)*(f[k]/monitor[r+numors*25])
...
for d in range(0,128):
    Effi_d[d]=np.divide(Ideal, Idrh1[d],out=np.zeros_like(Ideal), where=Idrh1[d]!=0)
